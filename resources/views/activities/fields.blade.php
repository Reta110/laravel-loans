...
<!-- Amount Field -->
<div class="form-group col-sm-6">
    {!! Form::label('tot_amount', __('messages.total_amount')) !!}
...
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('client_earnings', __('messages.client_earnings')) !!}
...
<div class="form-group col-sm-6">
    {!! Form::label('activity_type_id', __('messages.activity_type_id')) !!}
    {!! Form::select('activity_type_id', $activities, null, ['class' => 'form-control']) !!}
</div>

<!-- Name Field -->
<div class="form-group col-sm-6">
    {!! Form::label('name', __('messages.observations')) !!}
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('activities.index') !!}" class="btn btn-default">{{__('messages.cancel')}}</a>
</div>